<template>
  <section class="inspection">
    ...
    <article class="inspection__article">
      <p class="inspection__p">그린데이즈 검수센터는 상품포장 및 검수 전 과정을 CCTV로 촬영하고 있습니다.</p>
      <p class="inspection__p">배송 시 오배송, 누락이 발생하지 않도록 노력하고 있으며, 부득이하게 문제가 생긴다면 수령 직후 바로 고객센터를 통해</p>
...
.inspection__prev, .inspection__next {
  position: absolute;
  width: 20px;
  height: 20px;
  background-color: rgba(0, 0, 0, .5);
