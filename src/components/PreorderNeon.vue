	...
	<keep-alive>
		<div class="neon">
			<section class="neon__container">
				<header class="neon__header">한정된 기간동안만 열리는 특별한 타임세일!</header>
				<ol class="neon__letters" ref="switch">
					...
					<li class="neon__light--off neon__first-group neon__letters--space">E</li>
				...
				<footer class="neon__footer">
					<span class="preorder__text">
						지금
						<span class="preorder__text--highlighter">{{ howManyPreorders }}</span>
						개의 프리오더 진행 중
					</span>
				</footer>
			</section>
